...
function ChatBubble({
      ...
      <View style={[styles.rowRight, style]}>
        ...
        <View
          style={[
            ...
            text ? { maxWidth: 237 } : null, // 텍스트만 최대폭 제한
          ]}
        >
          {text ? (
  ...
  return (
    <View style={[styles.rowLeft, style]}>
      {showAvatar && <Image source={avatarSource} style={styles.avatar} />}
...
const styles = StyleSheet.create({
  ...
  bubbleBase: {
    ...
    alignItems: 'center',
    alignSelf: 'flex-start', // 내용 크기에 맞춰 위쪽에 붙도록
  },
  bubbleOtherCorners: {
  ...
  bubbleMeCorners: {
    ...
    borderTopRightRadius: radius.lg,
    borderBottomLeftRadius: radius.lg, // BR=0 느낌(꼬리)
  },
  img: {
